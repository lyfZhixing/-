    ...
    <body onload="body_load()">
        <div class="page-header">
            ...
            <div class="header-quicklink">
                ...
                <a href="jsp/changepassword.jsp">[修改密码]</a>
            </div>
        </div>
        <div class="page-body">
            <div class="page-sidebar">
                <div class="sidebar-menugroup">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menuitem active"><a href="jsp/mybookings.jsp">我的预定</a></li>
                        <li class="sidebar-menuitem"><a href="jsp/mymeetings.jsp">我的会议</a></li>
                    </ul>
                </div>
                <div class="sidebar-menugroup">
                    <div class="sidebar-grouptitle">人员管理</div>
                    <ul class="sidebar-menu">
                        <li class="sidebar-menuitem"><a href="jsp/departments.jsp">部门管理</></li>
